...
$xtpl = new XTemplate("detail.tpl", "modules/". $module_file ."/template");
// $menu = array('1' => 
//   array(
//     'index': '1.',
//     'name': 'Tìm kiếm thú cưng',
//     'url': '/manual/huong-dan-su-dung/tim-kiem-thu-cung-su-dung-tim-kiem-1.html'
//   ),
//   array(
//     'index': '1.1.',
//     'name': 'Giao diện tìm kiếm',
//     'url': '/manual/huong-dan-su-dung/tim-kiem-thu-cung-su-dung-tim-kiem-1.html'
//   ),
//   array(
//     'index': '1.2.',
//     'name': 'Thông tin thú cưng',
//     'url': '/manual/huong-dan-su-dung/tim-kiem-thu-cung-thong-tin-thu-cung-2.html'
//   ),
//   array(
//     'index': '1.3',
//     'name': 'Mua, bán, Phối',
//     'url': '/manual/huong-dan-su-dung/tim-kiem-thu-cung-mua-ban-phoi-nguoi-dung-can-lien-he-mua-ban-phoi-3.html'
//   ),
//   array(
//     'index': '1.3.1.',
//     'name': 'Người dùng cần liên hệ mua, bán, phối',
//     'url': '/manual/huong-dan-su-dung/tim-kiem-thu-cung-mua-ban-phoi-nguoi-dung-can-lien-he-mua-ban-phoi-3.html'
//   ),
//   array(
//     'index': '1.3.2.',
//     'name': 'Người cần đăng bán',
//     'url': '/manual/huong-dan-su-dung/tim-kiem-thu-cung-mua-ban-phoi-nguoi-can-dang-ban-4.html'
//   ),
//   array(
//     'index': '1.3.3.',
//     'name': 'Chủ nuôi liên hệ người có nhu cầu',
//     'url': '/manual/huong-dan-su-dung/tim-kiem-thu-cung-mua-ban-phoi-chu-nuoi-lien-he-nguoi-co-nhu-cau-5.html'
//   ),
//   array(
//     'index': '2.',
//     'name': 'Đăng ký, đăng nhập',
//     'url': '/huong-dan-su-dung/dang-ky-dang-nhap-dang-ky-6.html'
//   ),
//   array(
//     'index': '2.1.',
//     'name': 'Đăng ký',
...
//     'index': '2.2.',
//     'name': 'Đăng nhập',
//     'url': '/manual/huong-dan-su-dung/dang-ky-dang-nhap-dang-nhap-7.html'
//   ),
//   array(
//     'index': '3.',
//     'name': 'Quản lý thú cưng',
//     'url': '/manual/huong-dan-su-dung/quan-ly-thu-cung-them-thu-cung-8.html'
//   ),
//   array(
//     'index': '3.1.',
//     'name': 'Thêm thú cưng',
...
if (nv_user_in_groups($global_array_cat[$catid]['groups_view'])) {
  ...
  if (!$news_contents['id']) {
    $page_title = 'Error 404, Not Found, Brain Explored';
    $xtpl->assign('content', '');
  }
  else {
    $xtpl->assign('module_name', $module_name);
    $xtpl->assign('cat', $global_array_cat[$catid]['alias']);
    $menu = array();
    $menu_query = $db_slave->query('SELECT id, title, alias FROM ' . NV_PREFIXLANG . '_' . $module_data . '_rows where catid = ' . $catid);
    while ($menu_contents = $menu_query->fetch()) {
      $xtpl->assign('id', $menu_contents['id']);
      $xtpl->assign('alias', $menu_contents['alias']);
      $xtpl->assign('title', $menu_contents['title']);
    ...
    $xtpl->assign('content', $body_contents['bodyhtml']);
  }
}
